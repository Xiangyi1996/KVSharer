...
class ModelInference:
    def __init__(self, model_name: str, download_dir: str, use_kvsharer: bool = True, THRESHOLD: float = 0.5,
                 MAX_SHARED_LAYERS: int = 5, device: str = "cuda"):
...
class ExperimentRunner:
    def __init__(self, args: argparse.Namespace):
        self.args = args
        self.model_tester = ModelInference(args.aggregator, args.download_dir, args.use_kvsharer, args.threshold,
                                           args.max_shared_layers)
        self.results = []
        self.num_correct = 0
    ...
    def log_performance(self):
        ...
        avg_input_len = total_input_len / len(self.test_samples) if len(self.test_samples) > 0 else 0
        avg_output_len = total_output_len / len(self.test_samples) if len(self.test_samples) > 0 else 0
